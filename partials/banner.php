...
<div x-data="{ open : true }" x-show="open" class="fixed bottom-0 right-0 z-10 flex items-center justify-between p-3 m-2 bg-indigo-800 rounded-lg shadow-lg sm:m-4 sm:px-4">
    ...
    <div class="flex items-center ml-2">
        <button x-on:click="open = false" type="button" class="inline-flex items-center justify-center p-1 text-white rounded opacity-75 focus:outline-none hover:opacity-100 focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:opacity-75">
