...
function themealfa_enqueue_scripts() {
	...
	wp_enqueue_style( 'themealfa', themealfa_get_mix_compiled_asset_url( 'css/app.css' ), array(), $theme->get( 'Version' ) );
	wp_enqueue_script( 'themealfa', themealfa_get_mix_compiled_asset_url( 'js/app.js' ), array(), $theme->get( 'Version' ) );
}
